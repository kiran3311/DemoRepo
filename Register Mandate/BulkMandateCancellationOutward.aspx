<%@ page title="" language="C#" masterpagefile="~/Site.master" autoeventwireup="True" inherits="NACH_Application.BulkMandateCancellationOutward, App_Web_bulkmandatecancellationoutward.aspx.bf0ff4eb" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <div style="text-align: left;">
        <asp:UpdatePanel ID="uptPnl" runat="server" UpdateMode="Conditional">
            <ContentTemplate>
                <asp:Panel ID="pnl" GroupingText="Bulk Mandate Cancellation (Maker)" runat="server" Width="100%">
                    <div align="center">
