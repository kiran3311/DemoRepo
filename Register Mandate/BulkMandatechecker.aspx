<%@ page title="" language="C#" masterpagefile="~/Site.master" autoeventwireup="true" inherits="Register_Mandate_BulkMandatechecker, App_Web_bulkmandatechecker.aspx.bf0ff4eb" %>
...
.center img
{
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
     ...
     <asp:Panel ID="pnl" GroupingText="Batch Verification" CssClass="Panel" runat="server"   Width="100%"> 
          ...
          <table>
             ...
             <tr>
                 <td colspan ="2" align="center">
                     <asp:Button ID="btnok" runat="server" text="Approve Batch"  Height="25px" Width="30%" ForeColor="Blue" OnClick="btnok_Click" /> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
             ...
             <table >
              <tr>
                        <td colspan="2">
                            <asp:GridView ID="gridUMRN" runat="server" align="center" Visible="false" AllowPaging="True" AutoGenerateColumns="False" DataKeyNames="IHNO" ForeColor="#333333" 
                                GridLines="None" OnPageIndexChanging="gridUMRN_PageIndexChanging" PageSize="10"  Style="border: 1px solid black; margin: 0px auto; Width:370%; margin-left: -136%">
                                <EditRowStyle BackColor="#2461BF" />
                                <FooterStyle BackColor="#507CD1" Font-Bold="True" ForeColor="White" />
                                <HeaderStyle BackColor="#507CD1" Font-Bold="True" ForeColor="White" Height="20px" HorizontalAlign="Center" />
                                <AlternatingRowStyle BackColor="White" />
                                <Columns>
                                    <asp:TemplateField HeaderText="IHNO">
                                        <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle"  />
                                        <ItemTemplate>
                                           <asp:LinkButton ID="lblUMRNumber" runat="server"  font-size=" 15px"  Text='<%# Bind("IHNO") %>' OnClick="lblUMRNumber_Click"></asp:LinkButton>
   ...
   <asp:Panel ID="pnl3" GroupingText="Mandate Details" CssClass="Panel" runat="server" Visible="false"   Width="100%"> 
            ...
            <div id="Div1" runat="server" align="center" >    <%--style="display: none"--%>
                        ...
                        <tr>
                            ...
                            <td class="style9">
                                <asp:DropDownList ID="cboSearch" runat="server" Width="160px" AutoPostBack="True" Visible="false"
                                    ...
                                    <asp:ListItem>IHNO</asp:ListItem> 
                            ...
                            <td>
                                <asp:Button ID="btnSearch" runat="server" Text="Search" OnClick="btnSearch_Click"
                                 ...
                                 <asp:Button ID="BtnBack" runat="server" Text="Back" OnClick="BtnBack_Click"
                                    Style="height: 26px; margin-left:90%" class="myButton" Width="60px" />
                            </td>
                            <td>
                ...
                <div align="center">
                    <asp:Image ID="imgCheque" runat="server" Height="350px" Width="1050px" />
                </div>
                ...
                <table style="width: 100%; border: 1px solid #ccc;">
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtUtilityCode" Text="" runat="server" ReadOnly="true" Width="40%"
                                Enabled="False"></asp:TextBox>
                            <asp:TextBox ID="txtUtilityName" Text="" runat="server" ReadOnly="true" Width="40%"
                                Enabled="False"></asp:TextBox>
                        </td>
                        <td>
                        </td>
                        ...
                        <td>
                            <asp:TextBox ID="txtIHNO" runat="server" Width="58px" Enabled="False"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
