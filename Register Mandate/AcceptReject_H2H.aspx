<%@ page title="" language="C#" masterpagefile="~/Site.master" autoeventwireup="true" inherits="Register_Mandate_AcceptReject_H2H, App_Web_acceptreject_h2h.aspx.bf0ff4eb" %>
        ...
        <center>
            <asp:UpdatePanel ID="upPnl" runat="server">
                <ContentTemplate>
                    ...
                    <asp:Panel ID="pnl" GroupingText="Accept Reject Mandate" runat="server" Width="100%">
                        ...
                        <asp:CustomValidator ForeColor="Red" Display="None" ID="cvOk" runat="server" ValidationGroup="vgOK" OnServerValidate="cvOk_ServerValidate"></asp:CustomValidator>
                        <div align="center">
                            <table width="80%">
                                <tr>
                                    ...
                                    <td class="form-fld-val" style="width: 50%" align="left">
                                        <asp:TextBox ID="txtDate" Width="80px" runat="server" 
                                ...
                                <tr>
                                    <td align="center">
                                        <asp:Label ID="lblMsg" Text="Msg" runat="server" Font-Bold="True" 
