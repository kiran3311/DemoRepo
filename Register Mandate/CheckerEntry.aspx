    ...
    <script type="text/javascript">
        ...
        function ConfirmationBox(Obj) {
            ...
            if (result == true) {
                ...
                DoBlur(Obj);
                if (Obj.id == "MainContent_txtenddate") {
                    debugger;
                    checkenddate();
                }
                return true;
                                    ...
                                    <td>
                                        <table width="100%">
                                            <tr>
                                                ...
                                                <td  width="65%">
                                                     <asp:TextBox ID="txtstartdate" MsgCount="0" Width="80%" onkeypress="return NumberOnly();" onblur="FieldOnBlur(this)"
                                    ...
                                    <td valign="top">
                                        <table width="100%">
                                            ...
                                            <tr>
                                                ...
                                                onfocus="DoFocus(this);MagnifyImage(this);" OnTextChanged="checkenddate_Click"
