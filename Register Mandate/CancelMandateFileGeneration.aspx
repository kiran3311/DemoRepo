<%@ page title="" language="C#" masterpagefile="~/Site.master" autoeventwireup="true" inherits="Register_Mandate_CancelMandateFileGeneration, App_Web_cancelmandatefilegeneration.aspx.bf0ff4eb" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <asp:ScriptManager ID="ScriptManager1" runat="server" AsyncPostBackTimeout="6000"  EnablePageMethods="true">
     </asp:ScriptManager>   
            ...
            <table>
                <tr>
                            ...
                            <table width="100%">
                                ...
                                <tr>
                                    <td align="right" valign="top">
                                        <asp:Label ID="lblBatchFr" CssClass="lbl" Text="UMRN :" runat="server"></asp:Label>
                                    </td>
                    ...
                    <td class="style5" valign="top">
                        <table>
                                                ...
                                                <span>
                                                    <asp:Label ID="lblUtilityName" CssClass="lbl" Width="95px" runat="server" Text="Utility Name:"></asp:Label></span><span
                                                        style="padding-left: 3px"><asp:TextBox ID="txtUtilityName" Width="277px" runat="server"
                                                            ReadOnly="true"></asp:TextBox></span></div>
                                            <div style="margin-top: 5px">
                                                <span>
                            ...
                            <tr>
                                <td>
                                    <%--<asp:Panel ID="Panel2" runat="server" Style="margin-top: 10px;border: 1px solid #ccc;">--%>
                                    <asp:Panel ID="Panel2" runat="server" Style="margin-top: 35px;border: 1px solid black;">
                ...
                <tr>
                    <td colspan="2" align="center">
                        <span>
                            <asp:Button ID="btnProcess"  class="myButton" runat="server" CausesValidation="true" OnClick="btnProcess_Click"
                                OnClientClick="return cnfrmtym();" Text="Process" ValidationGroup="vgProcess" />
                            <asp:Button ID="btnClose"  class="myButton" runat="server" OnClick="btnClose_Click" Text="Close" />
                    </td>
                </tr>
                <tr>
                    <td colspan='2'>
