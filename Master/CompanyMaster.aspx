<%@ page title="" language="C#" masterpagefile="~/Site.master" autoeventwireup="true" inherits="NACH_Application.Mst_Company, App_Web_companymaster.aspx.28963a75" %>
        ...
        <ContentTemplate> 
            <div style="text-align: center;">
                ...
                <asp:ValidationSummary ForeColor="Red" ID="ValidationSummary" ValidationGroup="vgOk"
                    runat="server" HeaderText="Following errors occured while performing the action" align="left" />
                        ...
                        <tr>
                            <td colspan="2" style="text-align: right;">
                                <asp:Button ID="btnSave" runat="server" Style="margin-right: 5px" OnClick="btnSave_Click"
                                    Text="Save" Width="80" CausesValidation="true" ValidationGroup="vgsave" />
