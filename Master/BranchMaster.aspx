<%@ page title="" language="C#" masterpagefile="~/Site.master" autoeventwireup="true" inherits="NACH_Application.BranchMaster, App_Web_branchmaster.aspx.28963a75" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function gridviewScroll() {
            $('#<%=gvBranchDetails.ClientID%>').gridviewScroll({
                height: 200,
                width: 850,
        ...
        var pame = Sys.WebForms.PageRequestManager.getInstance();
        pame.add_endRequest(function () {
            gridviewScroll();
        });
        var pamd = Sys.WebForms.PageRequestManager.getInstance();
        pamd.add_endRequest(function () {
            $('#<%=gvBranchDetails.ClientID%>').gridviewScroll({
                height: 200,
                width: 850,
                horizontalbar: "hidden"
    ...
    <asp:Panel ID="pnl" GroupingText="Branch Details" runat="server" Width="100%">
