<%@ page title="" language="C#" masterpagefile="~/Site.master" autoeventwireup="true" inherits="SetUp_UnlockBatchOutward, App_Web_unlockbatchoutward.aspx.4cd3357d" %>
    ...
    <asp:UpdatePanel ID="updPanel1" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            <asp:ValidationSummary ForeColor="Red" ID="ValidationSummary" ValidationGroup="vgUnlock"
             ...
             <asp:Panel ID="pnl" GroupingText="Unlock Batch Outward" runat="server"
                Width="100%">
            <div>
                <table width="100%">
                    <tr>
                        ...
                        <td width="50%" align="right">
                                        ...
                                        <td align="left" width="50%">
                                            <asp:DropDownList ID="ddlBatch" runat="server" Width="200px" AutoPostBack="True" OnSelectedIndexChanged="ddlBatch_SelectedIndexChanged"></asp:DropDownList>
                                       </td>
                    </tr>
                    <tr>
