<%@ page title="" language="C#" masterpagefile="~/Site.master" autoeventwireup="true" inherits="SetUp_ResetPasswordNew, App_Web_resetpasswordnew.aspx.4cd3357d" %>
<%@ Register TagPrefix="uc" TagName="ErrorCtrll" Src="~/Control/ErrorCtrll.ascx" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<%--<a href="~/Bin/AjaxControlToolkitNew.dll">~/Bin/AjaxControlToolkitNew.dll</a>--%>
                                    ...
                                    <tr>
                                        ...
                                        <td align="left" class="style2">
                                          ...
                                          <%--  <asp:DropDownList ID="drpBranch" Style="padding: 2px" runat="server" Width="200px">--%>
                                               ...
                                               <asp:TextBox ID="txtUserID" runat="server" Width="200px" Style="padding: 2px"></asp:TextBox>

                                          
                                             <asp:AutoCompleteExtender ServiceMethod="GetSearch" MinimumPrefixLength="1" CompletionInterval="10"
                                                 EnableCaching="false" CompletionSetCount="10" TargetControlID="txtUserID" ID="AutoCompleteExtender1"
