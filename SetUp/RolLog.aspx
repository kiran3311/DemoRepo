<%@ page title="" language="C#" masterpagefile="~/Site.master" autoeventwireup="true" inherits="RolLog, App_Web_rollog.aspx.4cd3357d" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <asp:Panel ID="pnl" GroupingText="Role Log Report" runat="server" Width="100%">
                ...
                <table width="100%">
                    <tr>
                        <td align="left">
                            ...
                            <table width="50%" style="margin-bottom: 2%;">
                                <tr>
                                    <td align="right" class="style4">
                                        <asp:Label ID="Label2" runat="server" Text="From Date :"></asp:Label>
                                    </td>
                                    <td align="left" width="14%">
                                        <asp:TextBox ID="txtStartDate" Style="padding: 1px; text-transform: uppercase" width="80px" runat="server"></asp:TextBox>
                                    ...
                                    <td align="left" width="14%">
                                        <asp:TextBox ID="txtEndDate" Style="padding: 1px; text-transform: uppercase" width="80px" runat="server"></asp:TextBox>
