        ...
        if (urlType == '.jpg' || urlType == '.jpeg' || urlType == '.png' || urlType == '.gif' || urlType == '.bmp') {//code to show images
            ...
            if (url.indexOf('TB_iframe') != -1) {// either iframe or ajax window		
                ...
                if (params['modal'] != "true") {//iframe no modal
                    ...
                    $("#TB_window").append("<div id='TB_title'><div id='TB_ajaxWindowTitle' style='display:none;'>" + caption + "</div><div id='TB_closeAjaxWindow'><a href='#' id='TB_closeWindowButton' title='Close'><img src='../../Resx/DialogCtrl/images/close.png' id='TB_closeAjaxWindowImg'/></a></div></div> <div id='divSuccessMsg' class='divSuccess'> </div> <div id='divIFrame'><iframe frameborder='0' hspace='0' src='" + urlNoQuery[0] + "' id='TB_iframeContent' name='TB_iframeContent" + Math.round(Math.random() * 1000) + "' onload='tb_showIframe()' style='width:" + (ajaxContentW + 29) + "px;height:" + (ajaxContentH + 17) + "px;' > </iframe> </div> <div id='divActBtns' style='display:none;'> </div> <div id='divSuccessBtns' style='display:none;'> </div>");
                } else {//iframe modal
                    $("#TB_overlay").unbind();
                    //$("#TB_window").append("<iframe frameborder='0' hspace='0' src='"+urlNoQuery[0]+"' id='TB_iframeContent' name='TB_iframeContent"+Math.round(Math.random()*1000)+"' onload='tb_showIframe()' style='width:"+(ajaxContentW + 29)+"px;height:"+(ajaxContentH + 17)+"px;'> </iframe>");
                    $("#TB_window").append("<div id='TB_title'><div id='TB_ajaxWindowTitle'>" + caption + "</div><div id='TB_closeAjaxWindow'><a href='#' id='TB_closeWindowButton' title='Close'><img src='../../Resx/DialogCtrl/images/close.png' id='TB_closeAjaxWindowImg'/></a></div></div> <div id='divSuccessMsg' class='divSuccess' style='display:none;'> </div> <div id='divIFrame'><iframe frameborder='0' hspace='0' src='" + urlNoQuery[0] + "' id='TB_iframeContent' name='TB_iframeContent" + Math.round(Math.random() * 1000) + "' onload='tb_showIframe()' style='width:" + (ajaxContentW + 29) + "px;height:" + (ajaxContentH + 17) + "px;' ></iframe> </div> <div id='divActBtns' style='display:none;'> </div> <div id='divSuccessBtns' style='display:none;'> </div>");
                }
                ...
                if ($("#TB_window").css("display") != "block") {
                    if (params['modal'] != "true") {//ajax no modal
                        ...
                        $("#TB_window").append("<div id='TB_title'><div id='TB_ajaxWindowTitle'>" + caption + "</div><div id='TB_closeAjaxWindow'><a href='#' id='TB_closeWindowButton'><img src='../../Resx/DialogCtrl/images/close.png' id='TB_closeAjaxWindowImg'/></a></div></div><div id='TB_ajaxContent' style='width:" + ajaxContentW + "px;height:" + ajaxContentH + "px'></div>");
                    } else {//ajax modal                    
                        $("#TB_overlay").unbind();
