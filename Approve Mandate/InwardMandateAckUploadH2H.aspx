<%@ page title="" language="C#" masterpagefile="~/Site.master" autoeventwireup="true" inherits="Approve_Mandate_InwardMandateAckUploadH2H, App_Web_inwardmandateackuploadh2h.aspx.1f1b7ac7" %>
                                    ...
                                    <td colspan="2" align="left">
                                        <div id="dvDataFound" style="padding: 5px;" align="center">
                                            <asp:GridView ID="dgvData" runat="server" AutoGenerateColumns="False" AllowPaging="True"
                                                PageSize="1" CellPadding="4" ForeColor="#333333" GridLines="None" Width="70%"
