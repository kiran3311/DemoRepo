<%@ page title="" language="C#" masterpagefile="~/Site.master" autoeventwireup="true" inherits="Approve_Mandate_InwardMandateRegistrationNew, App_Web_inwardmandateregistrationnew.aspx.1f1b7ac7" %>
                ...
                <tr>
                    ...
                    <td class="style5" valign="top">
                        <table>
                            ...
                            <tr>
                                <td>
                                    <asp:Panel GroupingText="NPCI Details" CssClass="Panel" runat="server" ID="Panel1" style="margin-top: -4px;">
                                    ...
                                    <asp:Panel ID="Panel2" runat="server" Style="margin-top: 10px; border-color: Black;"
                                        ...
                                        <div style="margin: 5px; margin-left: 0px; margin-bottom: 10px">
                                            ...
                                            <div style="margin-top: 5px">
                                                ...
                                                <span style="padding-left: 3px">
                                                    <asp:TextBox ID="txtSucCancel" Width="107px" runat="server" ReadOnly="true" Height="22px"></asp:TextBox>
                                                </span><span style="padding-left: 3px">
                    ...
                    <td colspan="2" align="right">
                        <span>
                            <asp:Button ID="btnProcess" runat="server" CausesValidation="true" OnClick="btnProcess_Click"
                                OnClientClick="return cnfrmtym();" Text="Process" ValidationGroup="vgProcess" class="myButton" Width="70px" Height="25px" />
