<%@ page title="" language="C#" masterpagefile="~/Site.master" autoeventwireup="true" inherits="Approve_Mandate_DestInwMandateView, App_Web_destinwmandateview.aspx.1f1b7ac7" %>
                    ...
                    <asp:Panel ID="Panel1" runat="server" BorderWidth="1px" >
                        <table width="100%">
                            <tr><td colspan="2">
                                <table width="100%">
                                    <tr>
                                        <td width="25%" align="right"><asp:Label ID="lblCusName" runat="server" Text="Customer Name :"></asp:Label></td>
                                        <td width="75%" align="left"><asp:TextBox ID="txtCustName" Text="" runat="server" Width="100%" ReadOnly="true"></asp:TextBox></td>
                                    </tr>
                                </table>
                            </td></tr>         
                            <tr>
                                <td width="44%" valign="top">
                                    <table width="100%">
                                        <tr>
                                            <td width="35%" align="right"><asp:Label ID="lblUMRN" runat="server" Text="UMRN :"></asp:Label></td>
                                            <td width="65%" align="left"><asp:TextBox ID="txtUmrn" runat="server" ReadOnly="true" Text="" Width="100%"></asp:TextBox></td>
                                        </tr>
                                        
                                        <tr>
                                            <td width="35%" align="right"><asp:Label ID="lblAcType" runat="server" Text="A/C Type :"></asp:Label></td>
                                            <td width="65%" align="left"><asp:TextBox ID="txtAcType" runat="server" ReadOnly="true" Width="100%"></asp:TextBox></td>
                                        </tr>
                                        <tr>
                                            <td width="35%" align="right"><asp:Label ID="lblRef1" runat="server" Text="Ref1 :" ></asp:Label></td>
                                            <td width="65%" align="left"> <asp:TextBox ID="txtCustRefnNO" runat="server" ReadOnly="true" Width="100%"></asp:TextBox></td>
                                        </tr>
                                        <tr>
                                            <td width="35%" align="right"> <asp:Label ID="lblRef2" runat="server" Text="Ref2 :"></asp:Label></td>
                                            <td width="65%" align="left"><asp:TextBox ID="txtSchRefNo" runat="server" ReadOnly="true" Text="" Width="100%"></asp:TextBox></td>
                                        </tr>
                                        <tr>
                                            <td width="35%" align="right"> <asp:Label ID="lblMobile" Text="Mobile :" runat="server"></asp:Label></td>
                                            <td width="65%" align="left"> <asp:TextBox ID="txtMobile" Text="" runat="server" Width="100%" ReadOnly="true"></asp:TextBox></td>
                                        </tr>
                                       <tr>
                                            <td width="35%"  align="right"><asp:Label ID="lblMail" Text="Mail Id :"  runat="server" ></asp:Label></td>
                                            <td width="65%"  align="left"><asp:TextBox ID="txtMail" Text="" runat="server" style="text-align:right" Width="100%" ReadOnly="true"></asp:TextBox>     </td>
                                        </tr>
                                        <tr>
                                    ...
                                    Visible="false" Width="100%" ></asp:Label></td> 
                                        ...
                                        <tr>
                                            ...
                                            <td width="65%" align="left"><asp:TextBox ID="txtProdCategory" Text="" runat="server"  Width="100%" ReadOnly="true"></asp:TextBox></td>
                                        </tr>
                                        
                                         <tr>
                                            <td width="35%"  align="right"> <asp:Label ID="lblStatus" Text="Status :" runat="server"></asp:Label></td>
                                            <td width="65%"  align="left"> <asp:TextBox ID="txtStatus" runat="server" Width="100%" ReadOnly="true"></asp:TextBox></td>
                                        </tr>
                                    </table>
                                </td>
                                <td width="56%" valign="top">
                                    <table width="100%" border="0">
                                         <tr>
                                            <td width="35%" align="right"><asp:Label ID="lblActn" runat="server" Text="Action :"></asp:Label></td>
                                        ...
                                        <tr>
                                            <td width="35%" align="right"> <asp:Label ID="lblAmt" Text="Amt :" runat="server"></asp:Label></td>
                                            <td width="65%" align="left"><asp:TextBox ID="txtAmount" Text="" runat="server" Width="100%" ReadOnly="true"></asp:TextBox></td>
                                        </tr>
                                        <tr>
                                            <td width="35%" align="right"><asp:Label ID="lblFre" runat="server" Text="Frequency :"></asp:Label></td>
                                            <td width="65%" align="left"><asp:TextBox ID="txtFrequency" runat="server" ReadOnly="true" Text="" Width="100%"></asp:TextBox></td>
                                        </tr>
                                        <tr>
                                            <td width="35%" align="right"><asp:Label ID="lblColty" runat="server" Height="16px" Text="Type :"></asp:Label></td>
                                            <td width="65%" align="left"> <asp:TextBox ID="txtCollType" Text="" runat="server" Width="100%" ReadOnly="true"></asp:TextBox></td>
                                        </tr>
                                        <tr>
                                            <td width="35%" align="right"><asp:Label ID="lblStrt" runat="server" Height="16px" Text="StartDate :" style="text-align:right"></asp:Label></td>
                                            <td width="65%" align="left"><asp:TextBox ID="txtStartDate" runat="server" ReadOnly="true" Text="" Width="100%"></asp:TextBox></td>
                                        </tr>
                                        <tr>
                                            <td width="35%" align="right"><asp:Label ID="lblEnd" runat="server" Text="EndDate :"></asp:Label></td>
                                            <td width="65%" align="left"><asp:TextBox ID="txtEnddate" runat="server" ReadOnly="true" Text="" Width="100%"></asp:TextBox></td>
                                        </tr>
                                        <tr> 
                                            <td width="35%" align="right">&nbsp;</td>
                                            <td width="65%"  align="left"><asp:CheckBox ID="chkUntilCancel" runat="server" Text=" Until Cancel " Enabled="False"  Width="100%" /></td>
                                        </tr>
                                        <tr>
                                            <td width="35%" align="right"> <asp:Label ID="lblResaon" runat="server" Height="16px" Text="Reason :"></asp:Label></td>
                                            <td width="65%" align="left"> <asp:TextBox ID="txtReason" runat="server" style="text-align:left" Width="100%" ReadOnly="true"></asp:TextBox></td>
                                        </tr>
                                    </table>
                                </td>
                            </tr>
                        ...
                        <div>
                            <table width="100%">
                                 <tr>
                                     <td width="25%" align="right"> <asp:Label ID="lblReason" Text="Reason:" runat="server" style="text-align:right"></asp:Label></td>
                                     <td width="75%"> <asp:DropDownList runat="server" ID="ddlReject" Width="100%" Font-Size="8.8">
                                </asp:DropDownList></td>
                                 </tr>
                            </table>
                        </div>
