<%@ page title="" language="C#" masterpagefile="~/Site.master" autoeventwireup="true" inherits="Approve_Mandate_MandateCancellationDest, App_Web_mandatecancellationdest.aspx.1f1b7ac7" %>
                ...
                <table>
                    <tr>
                        ...
                        <td>
                            ...
                            <td>
                                <asp:Button runat="server" ID="Button1" Text="B&amp;W" OnClick="btnBW_Click" class="myButton" Width="60px" Height="25px" />
                            </td>
                    </tr>
                </table>
            </div>
