<%@ page title="" language="C#" masterpagefile="~/Site.master" autoeventwireup="true" inherits="Approve_Mandate_MandateCancellationDestChecker, App_Web_mandatecancellationdestchecker.aspx.1f1b7ac7" %>
                ...
                <table>
                    <tr>
                        ...
                        <td>
                            ...
                            <td>
                                <asp:Button ID="btnAccpt" runat="server" Text="Accept" OnClick="btnAccpt_Click" class="myButton" Width="60px" Height="25px" />
                            </td>
                            <td style="width: 5px">
                            </td>
                            <td>
                                <asp:Button ID="btnReject" runat="server" Text="Reject" class="myButton" Width="60px" Height="25px" OnClick="btnReject_Click1" />
                            </td>
                            <td style="width: 5px">
                            </td>
                            <td>
