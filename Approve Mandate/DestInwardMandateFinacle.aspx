<%@ page title="" language="C#" masterpagefile="~/Site.master" autoeventwireup="true" inherits="Approve_Mandate_DestInwardMandateFinacle, App_Web_destinwardmandatefinacle.aspx.1f1b7ac7" %>
                            ...
                            <div>
                                <table width="100%">
                                    <tr>
                                        ...
                                        <td width="left" width="75%">
                                            <asp:DropDownList runat="server" ID="ddlReject" Width="100%" Font-Size="8.8"></asp:DropDownList>
